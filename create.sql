...
create table circuit_schedule (id integer not null auto_increment, version integer, enabled bit not null, end_date datetime(6), frequency_days integer not null, start_date datetime(6), watering_time integer not null, circuit_id integer, user_id integer, primary key (id)) engine=InnoDB;
